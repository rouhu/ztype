    ...
    MenuSettings = Menu.extend({
        ...
        init: function () {
            ...
            if (ig.ua.mobile) {
                ...
                this.items[3].y = 490 / this.scale;
                this.items[4].y = Math.max(ig.system.height - 220, 590) / this.scale;
            } else {
                this.items[2].y = 390 / this.scale;
                this.items[3].y = Math.max(ig.system.height - 220, 490) / this.scale;
            }
        },
        itemClasses: [MenuItemSoundVolume, MenuItemMusicVolume, MenuItemWordDelay, MenuItemKeyboardLayout, MenuItemResume, MenuItemBack],
        draw: function () {
            this.width = ig.system.width / this.scale;
            var ctx = ig.system.context;
            this.parent();
            ...
            if (ig.ua.mobile) {
                this.font.draw('KEYBOARD  LAYOUT', ig.system.width / 2 / s, 460 / s, ig.Font.ALIGN.CENTER);
            }
            ctx.restore();
            var xs = this.width / 2;
            ctx.save();
